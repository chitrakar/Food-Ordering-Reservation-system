            ...
            while($row = fetch_array($runQuery)){
                ...
                elseif(isset($_POST['cart_checkout'])){//for cart checkout
					...
					<div class="row">
						...
						<div class="col-md-1 col-xs-1 col-sm-1"><input type="number" size="5" class="form-control qty" pid="'.$product_id.'" id="qty-'.$product_id.'" value="'.$qty.'" min=1 max=20 onkeydown="return false;" ></div>
